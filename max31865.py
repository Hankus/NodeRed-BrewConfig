...
class max31865(object):
    ...
    def calcPT100Temp(self, RTD_ADC_Code):
        ...
        #print ("Callendar-Van Dusen Temp (degC > 0): {:.2f} degC".format(temp_C))
...
if __name__ == "__main__":
    ...
    import max31865
    #csPin = int(sys.argv[1])
    #csPin = int(sys.argv[1])
    #csPin = int(sys.argv[1])
    misoPin = 9
    mosiPin = 10
    clkPin = 11
    #add as many sensors as you want just add the CS pin, you will need to update the array that is returned.
    max1 = max31865.max31865(24,misoPin,mosiPin,clkPin)
    max2 = max31865.max31865(12,misoPin,mosiPin,clkPin)
    max3 = max31865.max31865(16,misoPin,mosiPin,clkPin)
    temp1C = round(max1.readTemp(),1)
    temp2C = round(max2.readTemp(),1)
    temp3C = round(max3.readTemp(),1)
    output = {'hlt': temp1C,'mlt': temp2C,'bk': temp3C,}
    #print (round(temp1C,1))
    #print (round(temp2C,1))
    #print (round(temp3C,1))
